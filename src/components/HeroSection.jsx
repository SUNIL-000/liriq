...
const HeroSection = () => {
    return (
        <div className='text-center py-7 px-10 md:px-20  w-[100vw] gap-5 z-10'>
            ...
            <p className='text-[13px] md:text-sm w-full md:w-[60%] font-normal mx-auto mt-4 text-center text-pretty'>Discover the perfect setting for your next event at Liriq, where elegance meets functionality.
            ...
            <div className='w-full '>
                <img className='h-[250px] rounded-md w-[410px] mx-auto md:h-[35rem] md:w-full mt-3 bg-cover bg-no-repeat bg-current'
