...
const HeroSection = () => {
    return (
        <div className='text-center py-7 px-10 md:px-20  w-[100vw] gap-5 z-10'>
            ...
            <p className='text-[16px] md:text-sm w-full md:w-[60%] mx-auto mt-4 text-justify md:text-pretty'>Discover the perfect setting for your next event at Liriq, where elegance meets functionality.
